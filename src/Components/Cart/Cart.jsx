...
const Cart = ({cartList, handleRemoveItem, total, handleCheckOut}) => {
  ...
  return (
    <section className="cart">
      <h2>{`Your Cart (${handleAddCount()})`}</h2>
              ...
              <div className="items">
                {
                  cartList.map((cItem, index)=>(
                    <Item key={index} cItem={cItem} handleRemoveItem={handleRemoveItem}/>
                  ))
                }
              </div>
